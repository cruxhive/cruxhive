...
**Status**: Published. `cruxhive-mcp@0.20.1` on PyPI · `@cruxhive/cli@0.23.0` on npm. (0.19: approval gate enforced at retrieval, write-time reconciliation, UI XSS/DNS-rebind hardening, guardrail regex fixes, SQLite WAL. 0.20 CLI: `cruxhive skills sync` — one canonical skills dir distributed to Claude Code/OpenCode/Antigravity dialects; OpenCode wiring renamed AGENT.md → AGENTS.md.)
